...
export class V5SerialConnection extends VexSerialConnection {
  override filters: SerialPortFilter[] = [
...
function binaryArrayJoin(
  left: Uint8Array<ArrayBufferLike> | ArrayBufferLike | null,
  right: Uint8Array<ArrayBufferLike> | ArrayBufferLike | null,
    ...
    : (left &&
        all.set(
          left instanceof Uint8Array
            ? left
            : new Uint8Array(left as ArrayBuffer),
          0,
        ),
      right &&
        all.set(
          right instanceof Uint8Array
            ? right
            : new Uint8Array(right as ArrayBuffer),
          leftSize,
        ),
      all);
}
